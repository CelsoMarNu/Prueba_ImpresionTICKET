...
namespace TicketCS
{
	public class Ticket
	{
		...
		float leftMargin = 0;
		float topMargin = 3;
		string fontName = "Arial"; //El nombre de la fuente que se usara
		...
		private void DrawItems()
		{
			...
			gfx.DrawString("Producto   Cant.    P.Unit.   Total", printFont, myBrush, leftMargin, YPosition(), new StringFormat());
			count++;
